...
# Simulate evolution under directional selection
...
# Output
# Optimal protein level and sfitness function SD included in the file name
fn1=paste(opt,"_",width,"_",T,"_out_basic_end.txt",sep="") # End-point phenotype
write.table(out.end,file=fn1,sep="\t")
fn2=paste(opt,"_",width,"_",T,"_out_basic_var.txt",sep="") # Variance through time
