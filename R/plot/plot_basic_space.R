...
# Make heatmaps
dv$width=factor(dv$width,levels=c("1","5","10","50","100"),ordered=TRUE) # Convert the column to factor such that it is not treated as a continuous variable by ggplot2
